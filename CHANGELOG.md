...
- A reference clip that is not 16-bit is read at the right volume when that fallback runs; 24- and 32-bit files came out 32768x too loud and 8-bit ones 256x too quiet (#1931)
