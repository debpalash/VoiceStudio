...
4. **Voice and behavior.** Choose a voice (**Default voice** uses the engine's
   ...
   1,000 characters). **Add to greeting** inserts a short AI disclosure; some
   places require telling callers they hear an AI voice. **AI agent** answering
   arrives with Calls; until then VoiceStudio plays the greeting and hangs up.
