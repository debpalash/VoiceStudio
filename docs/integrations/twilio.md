...
1. Open **Integrations → Twilio**. Enter your **Account SID** and **Auth Token**
   ...
   greeting (up to 1,000 characters). The greeting is required only while
   incoming calls are answered with it; if the [call agent](calls.md) answers
   them, it can stay empty.
