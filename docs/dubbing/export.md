...
captions rendered into the frames. The caption file is passed to ffmpeg with
forward slashes so Windows drive-letter paths open in the subtitles and ass
filters. Two caption styles are available:
